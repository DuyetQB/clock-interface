...
mhnUI = {
    ...
    filter: function() {
        $(".mhn-ui-filter ").click(function() {
            ...
            $(".mhn-ui-filter-list").toggle(100), $(".mhn-ui-filter ").removeClass("active"), $(".mhn-ui-page-title").text($(this).text())
        })
    },
    colors: function() {
...
/*
    ...
    Author: dinh si duyet
    Copyright (c) 2020 Dinh Si Duyet - ignitersworld.com , released under the MIT license.
